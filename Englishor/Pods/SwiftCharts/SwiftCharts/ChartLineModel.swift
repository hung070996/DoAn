...
public struct ChartLineModel<T: ChartPoint> {
    ...
    public init(chartPoints: [T], lineColor: UIColor, lineWidth: CGFloat = 3, lineJoin: LineJoin = .round, lineCap: LineCap = .round, animDuration: Float, animDelay: Float, dashPattern: [Double]? = nil) {
